...
if( ! function_exists( 'cs_get_path_locate' ) ) {
  function cs_get_path_locate() {
    ...
    $admin_dir        = wp_normalize_path( get_template_directory() . '/core/admin' );
    $plugin_dir     = wp_normalize_path( WP_PLUGIN_DIR );
    $located_plugin = ( preg_match( '#'. $plugin_dir .'#', $admin_dir ) ) ? true : false;
    ...
    $basename       = str_replace( wp_normalize_path( $directory ), '', $admin_dir );
 ...
 *
 */
load_textdomain( 'valey', CS_DIR .'/languages/'. cs_get_locale() .'.mo' );
