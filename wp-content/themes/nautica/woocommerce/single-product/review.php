...
?>
<li itemprop="review" class="comment" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">

	<div id="comment-<?php comment_ID(); ?>" class="comment_container media">
		<div class="engo-avata pull-left">
		...
		<div class="comment-text media-body">
			<div class="comment-info">
				<div class="engo-author" itemprop="author"><?php comment_author(); ?></div>
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<p class="date"><em><?php esc_html_e( 'Your comment is awaiting approval', 'woocommerce' ); ?></em></p>
				<?php else : ?>
					<p class="date">
						<?php
