...
<div class="widget-vc nopadding">
		<div class="engo-inforbox <?php echo esc_attr($el_class);?> clearfix <?php echo esc_attr($inforbox_style); ?> <?php echo esc_attr($inforbox_alight); ?>"  style="<?php echo  implode(';', $style); ?>">
