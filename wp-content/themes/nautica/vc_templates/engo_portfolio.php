...
<div class="widget wpb_grid engo-portfolio <?php echo (($el_class!='')?' '.esc_attr( $el_class ):''); ?>">
      ...
      <div id="filters"  class="tab-v8 space-50">
        <div class="nav-inner">
          <ul class="nav nav-tabs isotope-filter categories_filter" data-related-grid="isotope-<?php echo esc_attr( $_id ); ?>">
            <?php
            echo '<li class="active"><a href="javascript:void(0)" title="" data-option-value=".all">'.esc_html__('All', 'nautica').'</a></li>';
