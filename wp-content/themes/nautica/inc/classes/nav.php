...
if( !class_exists("Nautica_bootstrap_navwalker") ){
class Nautica_bootstrap_navwalker extends Walker_Nav_Menu {
   ...
   /**
    ...
    public function start_lvl( &$output, $depth=0 ,$args = array() ) {
        ...
        $output    .= "\n$indent<p class=\"arrow\"></p><div class=\"dropdown-menu\"><ul>\n";
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if( $this->hasMega($item, $depth) ) {
            ...
            $class_names .= ' has-mega dropdown aligned-' . $item->alignment;
    ...
    public function genMegaMenuByConfig( $item, $depth ){
        ...
        return '<p class="arrow"></p><div class="dropdown-menu" '.$width.'><div class="mega-dropdown-menu">'.$content.'</div></div>';
    }
}}
