	...
	<div class="row">
		...
		<div id="main-content" class="main-content col-sm-12 <?php echo esc_attr($nautica_page_layouts['main']['class']); ?>">
			<div id="primary" class="content-area">
				<div id="content" class="site-content row view-mode <?php echo $view_mode_class;?> <?php echo $column_class;?>" data-role="main">

					<?php if ( have_posts() ) : ?>

					<header class="archive-header">
						<h1 class="archive-title"><?php printf( esc_html__( 'Category Archives: %s', 'nautica' ), single_cat_title( '', false ) ); ?></h1>
