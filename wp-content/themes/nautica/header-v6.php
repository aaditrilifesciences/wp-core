...
<div id="page" class="hfeed site"><div class="engo-page-inner row-offcanvas row-offcanvas-left">
		...
		<header id="engo-masthead" class="site-header engo-header-v6 engo-horizontal-megamenu header-black-version <?php nautica_fnc_get_header_possition();?>" role="banner">
			...
			<section id="engo-mainmenu" class="engo-mainmenu bg-gray-darker <?php nautica_fnc_get_header_sticky();?>">
				<div class="container">
					<div class="row">
						<div class="inner navbar-mega-light pull-left"><?php get_template_part( 'page-templates/parts/nav' ); ?></div>
