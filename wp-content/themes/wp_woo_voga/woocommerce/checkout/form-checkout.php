					...
					<div class="accordion-inner">
						<div class="col-sm-12 first block-wrapper">
							...
							<div class="login-regis text-strong">
								<p style="margin-bottom:5px;"><input id="clothchronicles_guest" type="radio" class="checkout-method" name="checkout-method"  value="guest"><?php _e('Checkout as Guest','wpdance');?></p>
								<p><input id="clothchronicles_user" type="radio" class="checkout-method" checked name="checkout-method" value="account"><?php _e('Create an Account with Us','wpdance');?></p>
							</div>
							<div class="description text-strong">
								...
								<ul>
									...
									<li><?php _e('+ Easy access to your order history and status.','wpdance');?></li>
								</ul>
							</div>
							...
							<input type="button" value="<?php _e( "Checkout as Guest","wpdance" );?>" name="button_create_account_continue" class="button_create_account_continue button next_co_btn left" rel="accordion-billing" onclick="checkoutbutton('guest')"><br/>
							<input type="button" value="<?php _e( "Create an Account with Us","wpdance" );?>" name="button_create_account_continue" class="button_create_account_continue button next_co_btn right" rel="accordion-billing" onclick="checkoutbutton('user')">
						</div>
				...
				<div class="accordion-group hidden accordion-createaccount" id="accordion-account">
					...
					<div id="collapse-createaccount" class="accordion-body collapse">
						<div class="accordion-inner">
							...
							<?php endif; ?>	
							<input id="clothchronicles_continue_account_create" type="button" value="<?php _e( "Continue","wpdance" );?>" name="button_billing_address_continue" class="button_billing_address_continue button next_co_btn" rel="accordion-billing">
						</div>
					</div>
				</div>					
