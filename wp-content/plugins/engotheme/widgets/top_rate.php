...
if(class_exists('PostRatings')){
    ...
    class Engotheme_Top_Rate_Widget extends Engotheme_Widget {
        public function __construct() {
            parent::__construct(
                // Base ID of your widget
                'engo_top_rate_widget',
                // Widget name will appear in UI
                __('ENGO Top Rate Widget', 'engotheme'),
                // Widget description
                array( 'description' => __( 'The highest rated posts on your site', 'engotheme' ), )
            );
    ...
    register_widget( 'Engotheme_Top_Rate_Widget' );
}