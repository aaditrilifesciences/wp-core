...
class Engotheme_Socials_Siderbar_Widget extends Engotheme_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'engo_socials_siderbar_widget',
            // Widget name will appear in UI
            __('ENGO Socials Siderbar', 'engotheme'),
            // Widget description
            array( 'description' => __( 'Share Socials Siderbar for website.', 'engotheme' ), )
        );
...
// Widget Backend
    ...
    ?>
    <div class="engo_socials_siderbar">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'list_service' )); ?>"><?php echo __( 'Share services social:', 'engotheme' ); ?></label>
            <br>
...
register_widget( 'Engotheme_Socials_Siderbar_Widget' );