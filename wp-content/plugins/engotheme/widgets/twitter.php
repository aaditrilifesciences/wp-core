...
class Engotheme_Tweets_Widget extends Engotheme_Widget{
    ...
    public function __construct() {
         parent::__construct(
            ...
            __('ENGO Latest Twitter', 'engotheme'),
            // Widget description
            array( 'description' => __( 'Latest Twitter widget.', 'engotheme' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $defaults = array( 'title' => __('Latest tweets.', 'engotheme'),
                            'user' => __('Leotheme', 'engotheme'),
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user' )); ?>"><?php _e('Twitter Username:', 'engotheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'limit' )); ?>"><?php _e('Limit:', 'engotheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'twitter_id' )); ?>"><?php _e('Twitter Id:', 'engotheme'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php _e('Border Color:', 'engotheme'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'link_color' )); ?>"><?php _e('Link Color:', 'engotheme'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php _e('Text Color:', 'engotheme'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'name_color' )); ?>"><?php _e('Name Color:', 'engotheme'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mail_color' )); ?>"><?php _e('Mail Color:', 'engotheme'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'transparent' )); ?>"><?php _e('Show background', 'engotheme'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_replies' )); ?>"><?php _e('Show Replies', 'engotheme'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_header' )); ?>"><?php _e('Show Header', 'engotheme'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_footer' )); ?>"><?php _e('Show Footer', 'engotheme'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_border' )); ?>"><?php _e('Show Border', 'engotheme'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_scrollbar' )); ?>"><?php _e('Show Scrollbar', 'engotheme'); ?></label>
            <br>
...
register_widget( 'Engotheme_Tweets_Widget' );
