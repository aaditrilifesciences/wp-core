...
class Engotheme_Facebook_Like_Box extends Engotheme_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'engo_facebook_like',
            // Widget name will appear in UI
            __('ENGO Facebook Like Box', 'engotheme'),
            // Widget description
            array( 'description' => __( 'Adds support for Facebook Like Box. ', 'engotheme' ), )
        );
...
register_widget( 'Engotheme_Facebook_Like_Box' );